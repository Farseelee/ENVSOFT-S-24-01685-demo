...
from tools import load_args, string_split
...
parser.add_argument('--setting_name', type=str, default='Crossformer_Data__d_model512__n_heads16__d_ff1024__batch_size128', help='name of the experiment')
...
mae, mse, rmse, mape, mspe, sse, sst = exp.eval(args.setting_name, args.save_pred, args.inverse)
...
log_file.write('MAE:{}\nMSE:{}\nRMSE:{}\nMAPE:{}\nMSPE:{}\nSSE:{}\nSST:{}\nr2_score:{}\n'.format(mae, mse, rmse, mape, mspe, sse, sst, 1-sse/sst))
log_file.close()